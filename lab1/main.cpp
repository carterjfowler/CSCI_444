...
GLFWwindow* setupGLFW() {
    ...
    GLFWwindow *window = glfwCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, "Lab1: OpenGL 4.1 Context", nullptr, nullptr );
...
void setupBuffers() {
    ...
    const Vertex cubeVertices[NUM_CUBE_VERTICES] = {
            ...
            { -0.5f, 0.5f, -0.5f, 1.0f, 0.0f, 0.0f}, // 3- tln
            { -0.5f, -0.5f, 0.5f, 0.0f, 0.0f, 1.0f}, // 4- blf
            { 0.5f, -0.5f, 0.5f, 0.0f, 1.0f, 1.0f}, // 5- brf
            { 0.5f, 0.5f, 0.5f, 1.0f, 1.0f, 1.0f}, // 6- trf
            { -0.5f, 0.5f, 0.5f, 1.0f, 0.0f, 1.0f}, // 7- tlf
    };
